...
| :------------------- | :-------------- | :----------|
|     V1.0.4-beta.1        | edgesolution/apphub-manager:v1.0.4-beta.1<br />edgesolution/apphub-emqx:v1.0<br />edgesolution/apphub-novnc:v1.2<br />edgesolution/apphub-postgres:v1.0<br />edgesolution/apphub-minio:v1.0 | eidevice/androiddm-javaenv-slim-dev:v5.1.7 <br />eidevice/apphub-emqx-dev:v1.0.9<br />eidevice/apphub-novnc-dev:v1.0.0<br />eidevice/androiddm-postgres-dev:v1.1<br />eidevice/androiddm-minio-dev:v1.1<br /> |
